...
import 'package:testapp/RegistrationPage/registrationController.dart';
          ...
          children: <Widget>[
            ...
            Text("Password *",
                style: TextStyle(
                    fontSize: ScreenUtil().setSp(textSizeMedium))),
            Obx(() => TextFormField(
              controller: regController.txtPassword.value,
              focusNode: regController.focusPassword.value,
              obscureText: regController.passwordInvisible.value,
              decoration: InputDecoration(
                  suffixIcon: IconButton(
                    icon: Icon(
                      regController.passwordInvisible.value
                          ? Icons.visibility_off
                          : Icons.visibility,
                    ),
                    onPressed: regController.passwordHideShow,
                  ),
                  hintText: "**********",
                  hintStyle: TextStyle(
                      color: appGreyColor,
            ...
            Text("Confirm Password *",
                style: TextStyle(
                    fontSize: ScreenUtil().setSp(textSizeMedium))),
            Obx(() => TextFormField(
              controller: regController.txtConfirmPassword.value,
              focusNode: regController.focusConfirmPassword.value,
              obscureText:
              regController.confirmPasswordInvisible.value,
              decoration: InputDecoration(
                  suffixIcon: IconButton(
                    icon: Icon(
                      regController.confirmPasswordInvisible.value
                    ...
                    onPressed:
                    regController.confirmPasswordHideShow,
                  ),
                  hintText: "**********",
                  hintStyle: TextStyle(
                      color: appGreyColor,
